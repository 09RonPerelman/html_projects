# BSMCH JavaScript Style Guide() {



שפת JavaScript היא שפת התכנות הפופולרית ביותר בעולם כיום, והיא תשמש אותנו רבות בהמשך הקורס.

השפה היא שפת סקריפטים, מה שאומר שהיא **לא עוברת קומפילציה טרם הריצה** ולכן יותר "מתירנית" בהרבה מאפיינים. מצד אחד זה מאפשר קוד מאוד דינמי וקל לפיתוח, אבל זה גם יכול להוביל לתוכניות מסורבלות, פתרונות לא אידיאליים לבעיות וקוד שקשה לתחזוקה.

בדומה ל - Java ול - C++ שלמדנו, יש צורך לקבוע **כללי פיתוח** ולהקפיד על **עבודה נכונה** בכתיבת תוכניות בJS

בחוברת זו יפורטו דגשים לכתיבת קוד "נקי" בשפת JavaScript. 


בחוברת יפורט על:

1. שמות סטנדרטיים עבור משתנים ופונקציות

2. כללי שימוש בעימוד ובתיעוד

3. עקרונות וקווים מנחים בכתיבת קוד

רוב המידע בחוברת מבוסס על הסטנדרטים הנהוגים בחברות גדולות כמו Google ו- AirBnB
עבור רוב הכללים מצורפים חוקים קשורים ב-[ESLint](https://eslint.org/docs/user-guide/getting-started). זהו כלי אוטומטי לתיקון סטנדרטים וכו' בקוד. מרבית הדגשים בחוברת חופפים לכללים הדיפולטיים ב - ESLint.
יישום הדגשים בחוברת זו יביאו לקוד קריא, יעיל וקל לתחזוקה.

ממבט חטוף על התוכן עניינים, או מלהסתכל על החוברת עצמה ניתן לראות שהיא ארוכה. ולא רק שהיא ארוכה, כמעט כולה באנגלית. זה עלול להיות מרתיע.
אז חניך/ה יקר/ה, אין צורך להיכנס ללחץ. להלן דגשים לאיך לעבור את הסיפור בהצלחה:
1.  להתקין ESlint, קישור מופיע למעלה. הוא יעזור לנו לשמור על הרבה מהכללים
2.  אין צורך להכיר את החוברת בעל פה - אתם מתלבטים לגבי משהו, תפנו אל החוברת ותגיעו לחלק הרצוי דרך תוכן העניינים. לאט לאט כשתעבדו זה כבר ייטמע בכם.
3. בתחילת כל חלק יופיעו משפט או שניים בעברית שיסבירו במה עוסק החלק המדובר. עברו עליהם על מנת שהכותרות המעורפלות יהיו ברורות יותר.
4.  תתחילו בלרפרף על החוברת, תבינו איך היא בנויה ומה כל חלק מכיל. זה ביחד עם התוכן ענייינים יעזור לכם לשלוט בחוברת!
...
## Table of Contents
  ...
  1. [Classes and Constructors](#classes-and-constructors)
  1. [Modules](#modules)
  1. [Iterators](#iterators)
  1. [Properties](#properties)
  1. [Variables](#variables)
  1. [Hoisting](#hoisting)
  1. [Comparison Operators and Equality](#comparison-operators-and-equality)
  1. [Blocks](#blocks)
...
## Types
    בחלק זה נפרט על הטיפוסים בJS, מי מהם הוא כתובת(מצביע) ומי ערך ישיר
  ...
  - [1.2](#types--complex)  **Complex**: When you access a complex type you work on a reference to its value.
    ...
    ```
Keep that in mind when sending parameters/using variables inside functions.
**[⬆ back to top](#table-of-contents)**

## References
    בחלק זה נדון על סוגים שונים של הגדרת משתנים - ומתי נשתמש בכל אחד
...
## Objects
    בחלק זה נדון בסטנדרטים של אובייקטים, השדות בתוכם וצורת כתיבה שונות וקיצורים.
  ...
  - [3.7](#objects--rest-spread) Prefer the object spread operator over [`Object.assign`](https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/Object/assign) to shallow-copy objects. Use the object rest operator to get a new object with certain properties omitted.
    ...
    ```
  - [3.8](#objects-field-name) Do not state the object itself inside a field name
...
## Arrays
    בחלק זה נדבר על כללים למערכים. איך צריך להגדיר אותם, להשתמש בהם ולבצע עליהם פעולות מתקדמות כמו פילטור ושינוי מסויים.
...
## Destructuring
    בחלק זה נדבר על פירוק של טיפוסים מורכבים כמו מערכים ואובייקטים לתוך משתנים שונים.
...
## Strings
    כאן נדבר על מחרוזות - איך נגדיר אותן באופן סטנדרטי ואין נשרשר אליהן משתנים.
...
## Functions
    בחלק הזה נדבר על הסטנדרטים של הפונקציות, איך יש להגדירן ולקרוא להן מבחינה סטנדרטית ואיך נעבוד עם הפרמטרים.    
  ...
  - [7.1](#functions--declarations) Use named function expressions instead of function declarations. eslint: [`func-style`](https://eslint.org/docs/rules/func-style)
    ...
    // best - מכיוון שנוכל לדעת מאיזה פונקציה קפצה שגיאה
    // exception at <anonymous function> - אחרת יהיה כתוב בחלק מהדפדפנים 
    const short = function longUniqueMoreDescriptiveLexicalFoo() {
      // ...
    };
    
     // ניתן לתת את אותו השם למשתנה ולפונקציה
...
## Arrow Functions
    כאן נדבר על פונקציות חץ, מתי נשתמש בהן ואיך נעשה את זה בצורה הכי ברורה שניתן. פונקציות חץ נוספו לJS ביחד עם ES6 והיום משתמשים בהן המון.
...
שימו לב שלא נעשה שימוש בקונספט הזה בצד לקוח, אבל נמצא כאן במידה ותרצו ללמוד ולהשתמש בו בעצמכם. [דילוג לנושא הבא](#modules)

 בחלק זה נדבר עם מחלקות - איך יש להגדיר אותן, מה הסטנדרטים שלהם ואיך נכון לעבוד איתן.
...
## Modules
    בחלק זה נדבר על פיצול למודולים. איך נקבל קוד מקובץ אחר בצורה סטנדרטים ואיך נחלק קוד.
  ...
  - [10.1](#modules--use-them) Always use modules (`import`/`export`) over a non-standard module system. You can always transpile to your preferred module system.
    ...
    ```javascript
    // bad
    const BsmchStyleGuide = require('./BsmchStyleGuide');
    module.exports = BsmchStyleGuide.es6;

    // ok
    import BsmchStyleGuide from './BsmchStyleGuide';
    export default BsmchStyleGuide.es6;

    // best
    import { es6 } from './BsmchStyleGuide';
    export default es6;
    ```
  ...
  - [10.2](#modules--no-wildcard) Do not use wildcard imports.
    ...
    ```javascript
    // bad
    import * as BsmchStyleGuide from './BsmchStyleGuide';
...
## Iterators 
    בחלק זה נדבר על הדרך הסטנדרטית לעבד מערכים.
...
## Properties
    כאן יופיע הסבר על איך לגשת בצורה סטנדרטים לשדות בתוך אובייקט.
...
## Variables
    בחלק הזה נדבר יותר בהרחבה על איך נשתמש במשתנים, איך נגדיר אותם ואיפה ואיך נעבוד איתם.
...
<a name="variables--no-unused-vars"></a>
  - [13.8](#variables--no-unused-vars) Disallow unused variables. eslint: [`no-unused-vars`](https://eslint.org/docs/rules/no-unused-vars)
    ...
    ```
<a name="variables--no-unused-vars"></a>
  - [13.9](#variables--no-unused-vars) Give meaningful names to variables, without prefixes or type statments.
    ...
    // bad
    const prnPerson = { name: "Nadav" };

    // good
    let count = 0;
    const nadav = { name: "Nadav" };

    ```
**[⬆ back to top](#table-of-contents)**

## Hoisting
    בחלק הזה נבין מה זה hoisting ומשם נבין מה ההשלכות שלו ואיך נכון לכתוב בהתאם.
...
## Comparison Operators and Equality
    בחלק הזה נדבר על תנאים והשוואות, איך נעשה אותם בצורה סטנדרטים (כי הרבה דברים יכולים לעבוד למרות שעדיף שלא נעשה אותם ככה). נדבר על ביטויים טרינארים ועל switch.
...
<a name="comparison--shortcuts"></a><a name="15.3"></a>
  - [15.3](#comparison--shortcuts) Use ternaries for simple [expressions & statements](https://2ality.com/2012/09/expressions-vs-statements.html). Otherwise, use regular  ``if`` clause. 
	...
	(a == b & b != 0 && c > b) ? a.username.concat('nadav') :  a.age = 18;
	

    // good
    count = a === b ? 1 : 0;
    if(a == b && b != 0 && c > b) {
		a.username.concat('nadav');
	} else {
		a.age = 18;
	}
    ```
  ...
  - [15.5](#comparison--switch-blocks) Use braces to create blocks in `case` and `default` clauses that contain lexical declarations (e.g. `let`, `const`, `function`, and `class`). eslint: [`no-case-declarations`](https://eslint.org/docs/rules/no-case-declarations.html)
    ...
    switch (foo) {
      ...
      case 2:
        const y = 2;
        let x = 1; // In this example this line
			       // Will cause an error because x
  ...
  - [15.7](#comparison--unneeded-ternary) Avoid unneeded ternary statements. eslint: [`no-unneeded-ternary`](https://eslint.org/docs/rules/no-unneeded-ternary.html)
    ...
    const baz = !c;
    ```
[what is !! ?](https://stackoverflow.com/questions/784929/what-is-the-not-not-operator-in-javascript)
...
## Blocks
    בחלק הזה נדבר על איך לעצב את הקוד (נראותית) מבחינת סוגריים.
  ...
  - [16.3](#blocks--no-else-return) If an `if` block always executes a `return` statement, the subsequent `else` block is unnecessary. A `return` in an `else if` block following an `if` block that contains a `return` can be separated into multiple `if` blocks. eslint: [`no-else-return`](https://eslint.org/docs/rules/no-else-return)
    ...
    function dogs(x) {
      if (x) {
        if (z) { // Example to a place where it's ok to have 
			     // return in the else
          return y;
        }
      } else {
...
## Control Statements
    כאן נדבר על עבודה סטנדרטית ונכונה עם תנאים ולולאות.
...
## Comments
    כאן נדון בסטנדרטים של ההערות, שורות רווח, רווחים בהתחלה וכד - אתם כבר אמורים להכיר את הכל מעת"פ
...
## Whitespace
    כאןהייתיצריךלשיםרווחים. איפה עוד? בחלק הזה נדבר על רווחים, אורכים של שורות וכל הסטנדרטים שנובעים מכך.
  ...
  - [19.13](#whitespace--max-len) Avoid having lines of code that are longer than 100 characters (including whitespace). Note: per [above](#strings--line-length), long strings are exempt from this rule, and should not be broken up. eslint: [`max-len`](https://eslint.org/docs/rules/max-len.html)
    ...
    // bad
    $.ajax({ method: 'POST', url: 'https://bsmch.com/', data: { name: 'John' } }).done(() => console.log('Congratulations!')).fail(() => console.log('You have failed this city.'));
...
## Commas
    איפה ומתי נשים פסיקים(ואפילו נימוק משכנע למה)
  <a name="commas--leading-trailing"></a><a name="19.1"></a>
  - [20.1](#commas--leading-trailing) Leading commas: **Nope.** commas will always come at the end on the line. eslint: [`comma-style`](https://eslint.org/docs/rules/comma-style.html)
  ...
  - [20.2](#commas--dangling) Additional trailing comma: **Yup.** Which means we will write a comma even if it's the last element. eslint: [`comma-dangle`](https://eslint.org/docs/rules/comma-dangle.html)

    > Why? This leads to cleaner git diffs. Also, transpilers like Babel will remove the additional trailing comma in the transpiled code which means you don’t have to worry about the [trailing comma problem](https://github.com/bsmch/javascript/blob/es5-deprecated/es5/README.md#commas) in legacy browsers.
...
## Semicolons
    בחלק זה נדבר על נקודה פסיק - מתי נשים?
...
## Type Casting and Coercion
    בחלק זה נדבר על הסבות - מתי נעשה ואיך
    
  <a name="coercion--explicit"></a><a name="21.1"></a>
  - [22.1](#coercion--explicit) Perform type coercion ("הסבה") at the beginning of the statement.
  ...
  - [22.5](#coercion--bitwise) **Note:** Be careful when using bitshift operations. Numbers are represented as [64-bit values](https://es5.github.io/#x4.3.19), but bitshift operations always return a 32-bit integer ([source](https://es5.github.io/#x11.7)). Bitshift can lead to unexpected behavior for integer values larger than 32 bits. [Discussion](https://github.com/bsmch/javascript/issues/109). Largest signed 32-bit Int is 2,147,483,647:
  ...
  - [22.6](#coercion--booleans) Booleans: eslint: [`no-new-wrappers`](https://eslint.org/docs/rules/no-new-wrappers)
    ...
    // best
    const hasAge = !!age; // Double bang operator
    ```

**[⬆ back to top](#table-of-contents)**

## Naming Conventions
  כאן נלמד לתת שמות למשתנים ודברים שונים בצורה ברורה וסטנדרטית.
   נשמע פשוט?  תשאלו את אילון מאסק.
  ...
  - [23.8](#naming--PascalCase-singleton) Use PascalCase when you export a constructor / class / singleton / function library / bare object.
    ...
    ```javascript
    const BsmchStyleGuide = {
      es6: {
      },
    };

    export default BsmchStyleGuide;
    ```
...
## Events
  כאן נדבר על הסטנדרטים של אירועים בJS.
...
## Standard Library
  כאן נדבר על סטנדרטים שנוגעים לפונקציות המובנות בספרייה הסטנדרטית של JS.
...
לסיכום, כמו שכתבתנו בהתחלה יש המון סטנדרטים והמון פסקאות. חשוב להכיר אותם ולעבוד לפיהן אבל אין צורך לשנן הכל. כמו שראיתם בתחילת כל חלק מופיע הסבק קתר בעברית על מנת להקל עליכם. תבינו איך להתמצא בחוברת ותתקינו ESlint. משם הכל יהיה פשוט יורת.
